...
import hero from 'photo/lavender-background-1.jpg'
...
export default function HomePage() {
  ...
  return (
    <Paper sx={paperMainStyle(hero)}>
      <Box sx={boxMainStyle}>
        {isLoggedIn ? (<><Typography component="h1" variant="h3" color="Indigo" gutterBottom>
          Hi, {user.name}! <br />
          Welcome to your phonebook! </Typography>
        </>) :
          (<><Typography component="h1" variant="h3" color="Indigo" gutterBottom>
            Hello! I'm your phonebook. </Typography>
            <Typography variant="h5" color="Indigo" paragraph>
